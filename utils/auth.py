...
def get_supabase_credentials() -> Tuple[str, str]:
    ...
    """
    url = get_env("SUPABASE_URL", "https://dcswtssvksfzsuiioevy.supabase.co")
    key = get_env("SUPABASE_KEY", "YOUR_SUPABASE_KEY_HERE")  # Add a default value for the key
...
def get_webhook_credentials() -> Tuple[str, str, str]:
    ...
    """
    chat_url = get_env("N8N_WEBHOOK_CHAT_URL", "http://localhost:5678/webhook/webhook-path")
    # Updated URL to use ngrok for external access
    update_url = get_env("N8N_WEBHOOK_UPDATE_URL", "https://evidently-tight-yak.ngrok-free.app/webhook/webhook-update-supabase")
